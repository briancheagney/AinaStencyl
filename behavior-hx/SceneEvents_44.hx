...
class SceneEvents_44 extends SceneScript
{
	...
	public var _ColorMatchFalse:Actor;
	public var _ANCT:Float;
	public var _ANCM:Float;
	public var _MatchShapeText:String;
	public var _MatchShapeNumber:Float;
	public var _ANCMF:Float;
	public var _MatchShapeTextFalse:String;
	...
	public function _customEvent_ChooseTargetShapeNew():Void
	{
		...
		_customEvent_ChooseTargetNUMBER();
	}
	
	/* ========================= Custom Event ========================= */
	public function _customEvent_ChooseTargetNUMBER():Void
	{
		_ANCT = asNumber(randomInt(Math.floor(1), Math.floor(4)));
		propertyChanged("_ANCT", _ANCT);
		_ANCM = asNumber(randomInt(Math.floor(1), Math.floor(4)));
	...
	public function _customEvent_SetThemAll():Void
	{
		...
		_NoMatch.setAnimation("" + ("" + (("" + (("" + _ChooseColorNoMatch) + ("" + _ChooseShapeNoMatch))) + ("" + (("" + "0") + ("" + _ANCT))))));
		trace("" + (("" + "Target Color = ") + ("" + _ChooseColorTarget)));
		trace("" + (("" + "Target Shape = ") + ("" + _ChooseShapeTarget)));
		trace("" + (("" + "Target Number = ") + ("" + _ANCT)));
		trace("" + (("" + "Match Color = ") + ("" + _ChooseColorMatch)));
		trace("" + (("" + "Match Shape = ") + ("" + _ChooseShapeMatch)));
		trace("" + (("" + "Match Number = ") + ("" + _ANCM)));
		trace("" + (("" + "NoMatch Color = ") + ("" + _ChooseColorNoMatch)));
		trace("" + (("" + "NoMatch Shape = ") + ("" + _ChooseShapeNoMatch)));
		trace("" + (("" + "NoMatch Number = ") + ("" + _ANCT)));
	...
	public function new(dummy:Int, dummy2:Engine)
	{
		...
		_ACCMF = 0.0;
		nameMap.set("ColorMatchFalse", "_ColorMatchFalse");
		nameMap.set("ANC_T", "_ANCT");
		_ANCT = 0.0;
		nameMap.set("ANC_M", "_ANCM");
		_ANCM = 0.0;
		nameMap.set("MatchShapeText", "_MatchShapeText");
		_MatchShapeText = "";
		nameMap.set("MatchShapeNumber", "_MatchShapeNumber");
		_MatchShapeNumber = 0.0;
		nameMap.set("ANC_MF", "_ANCMF");
		_ANCMF = 0.0;
		nameMap.set("MatchShapeTextFalse", "_MatchShapeTextFalse");
		_MatchShapeTextFalse = "";
	...
	override public function init()
	{
		...
		Engine.engine.setGameAttribute("L19_2var_Shape_Num_TotalNum", (Engine.engine.getGameAttribute("L19_2var_Shape_Num_TotalNum") + 1));
		runLater(1000 * .1, function(timeTask:TimedTask):Void
		{
			...
			_Item[Std.int(1)] = Engine.engine.getGameAttribute("L19_2var_Shape_Num_TotalNum");
			_Item[Std.int(2)] = (("" + (("" + Date.now().getHours()) + ("" + ":"))) + ("" + (("" + (("" + Date.now().getMinutes()) + ("" + ":"))) + ("" + Date.now().getSeconds()))));
			Engine.engine.getGameAttribute("L19Date")[Std.int(Engine.engine.getGameAttribute("L19_2var_Shape_Num_TotalNum"))] = _Item;
		}, null);
		...
		addMouseOverActorListener(_Match, function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				if((_Matchable == true))
				{
					...
					_Match.setX(-1200);
					trace("" + "True");
					trace("" + Engine.engine.getGameAttribute("L19Date"));
					if((_counter == 10))
					{
