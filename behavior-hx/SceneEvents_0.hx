...
class SceneEvents_0 extends SceneScript
{
	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				if((((Engine.engine.getGameAttribute("StatsLevel") == 18) || (Engine.engine.getGameAttribute("StatsLevel") == 21)) || (Engine.engine.getGameAttribute("StatsLevel") == 22)))
				{
			...
			if(wrapper.enabled)
			{
				if((Engine.engine.getGameAttribute("StatsLevel") == 2))
				{
					...
					if(((Engine.engine.getGameAttribute("L02Date01").length >= 2) && (Engine.engine.getGameAttribute("L02Date01").length > Engine.engine.getGameAttribute("StatsLevel01sub"))))
					{
						...
						g.drawString("" + (("" + ("" + Engine.engine.getGameAttribute("L02Date01")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(3)]).substring(Std.int(0), Std.int(3))) + ("" + (("" + " ") + ("" + ("" + Engine.engine.getGameAttribute("L02Date01")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(3)]).substring(Std.int(5), Std.int(12)))))), _Xvalue, _Line06PercentCorrect);
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				if((Engine.engine.getGameAttribute("StatsLevel") == 22))
				{
					g.setFont(getFont(259));
					g.drawString("" + Engine.engine.getGameAttribute("L22Date")[Std.int(0)], _Xvalue, _Line01Level);
					if(((Engine.engine.getGameAttribute("L22Date").length >= 2) && (Engine.engine.getGameAttribute("L22Date").length > Engine.engine.getGameAttribute("StatsLevel01sub"))))
					{
						g.drawString("" + (("" + "Date: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(0)])), _Xvalue, (_Line01Level + (2 * _WCSTSpacing)));
						g.drawString("" + (("" + "Set: ") + ("" + (("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(1)]) + ("" + (("" + "/") + ("" + (Engine.engine.getGameAttribute("L22Date").length - 1))))))), 0, 0);
						g.drawString("" + (("" + "Time: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(2)])), _Xvalue, (_Line01Level + (3 * _WCSTSpacing)));
						g.drawString("" + (("" + "# of Trials: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(3)])), _Xvalue, (_Line01Level + (4 * _WCSTSpacing)));
						g.drawString("" + (("" + "# Correct: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(4)])), _Xvalue, (_Line01Level + (5 * _WCSTSpacing)));
						g.drawString("" + (("" + "% Correct: ") + ("" + (("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(5)]) + ("" + "%")))), _Xvalue, (_Line01Level + (6 * _WCSTSpacing)));
						g.drawString("" + (("" + "Perseverative Errors: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(6)])), _Xvalue, (_Line01Level + (7 * _WCSTSpacing)));
						g.drawString("" + (("" + "% Perseverative Errors: ") + ("" + (("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(7)]) + ("" + "%")))), _Xvalue, (_Line01Level + (8 * _WCSTSpacing)));
						g.drawString("" + (("" + "Non-Perseverative Erros: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(8)])), _Xvalue, (_Line01Level + (9 * _WCSTSpacing)));
						g.drawString("" + (("" + "Total Errors: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(9)])), _Xvalue, (_Line01Level + (10 * _WCSTSpacing)));
						g.drawString("" + (("" + "% Errors: ") + ("" + (("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(10)]) + ("" + "%")))), _Xvalue, (_Line01Level + (11 * _WCSTSpacing)));
						g.drawString("" + (("" + "Trials to Complete First Category: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(11)])), _Xvalue, (_Line01Level + (12 * _WCSTSpacing)));
						g.drawString("" + (("" + "Categories Achieved: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(12)])), _Xvalue, (_Line01Level + (13 * _WCSTSpacing)));
						g.drawString("" + (("" + "%  Conceptual Level Responses: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(13)])), _Xvalue, (_Line01Level + (14 * _WCSTSpacing)));
						g.drawString("" + (("" + "Failures to Maintain Set: ") + ("" + Engine.engine.getGameAttribute("L22Date")[Std.int(Engine.engine.getGameAttribute("StatsLevel01sub"))][Std.int(14)])), _Xvalue, (_Line01Level + (15 * _WCSTSpacing)));
					}
				}
			}
		});
