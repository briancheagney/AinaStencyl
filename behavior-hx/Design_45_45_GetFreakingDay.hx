	...
	override public function init()
	{
		...
		addMouseOverActorListener(actor, function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				...
				trace("" + Engine.engine.getGameAttribute("GetDayYear"));
			}
		});
		...
		addMouseOverActorListener(actor, function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				while(!(((Engine.engine.getGameAttribute("GetDayMonthBool") == true) && ((Engine.engine.getGameAttribute("GetDayDateBool") == true) && (Engine.engine.getGameAttribute("GetDayYearBool") == true)))))
				{
					trace("" + "waiting");
				}
				Engine.engine.setGameAttribute("GetFreakingDay", (Engine.engine.getGameAttribute("GetDayDate") + (Engine.engine.getGameAttribute("GetDayMonth") + Engine.engine.getGameAttribute("GetDayYear"))));
				trace("" + (("" + "Freaking Day =") + ("" + Engine.engine.getGameAttribute("GetFreakingDay"))));
				while(!((Engine.engine.getGameAttribute("GetFreakingDay") < 8)))
				{
					if((Engine.engine.getGameAttribute("GetFreakingDay") > 7))
					{
						Engine.engine.setGameAttribute("GetFreakingDay", (Engine.engine.getGameAttribute("GetFreakingDay") - 7));
					}
				}
				trace("" + (("" + "Freaking Day =") + ("" + Engine.engine.getGameAttribute("GetFreakingDay"))));
