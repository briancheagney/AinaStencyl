...
class SceneEvents_25 extends SceneScript
{
	...
	override public function init()
	{
		...
		Engine.engine.setGameAttribute("L09Col01TotalNum", (Engine.engine.getGameAttribute("L09Col01TotalNum") + 1));
		runLater(1000 * .1, function(timeTask:TimedTask):Void
		{
			...
			_Item[Std.int(1)] = Engine.engine.getGameAttribute("L09Col01TotalNum");
			_Item[Std.int(2)] = (("" + (("" + Date.now().getHours()) + ("" + ":"))) + ("" + (("" + (("" + Date.now().getMinutes()) + ("" + ":"))) + ("" + Date.now().getSeconds()))));
			Engine.engine.getGameAttribute("L09Date01")[Std.int(Engine.engine.getGameAttribute("L09Col01TotalNum"))] = _Item;
		}, null);
