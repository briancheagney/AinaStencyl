...
class SceneEvents_35 extends SceneScript
{
	...
	public function _customEvent_ChooseTarget():Void
	{
		...
		if((_TargetChooser == 1))
		{
			...
			_NoMatchMoon = true;
			propertyChanged("_NoMatchMoon", _NoMatchMoon);
		...
		else if((_TargetChooser == 2))
		{
			...
			_NoMatchClub = true;
			propertyChanged("_NoMatchClub", _NoMatchClub);
	...
	override public function init()
	{
		...
		Engine.engine.setGameAttribute("L08TotalNum", (Engine.engine.getGameAttribute("L08TotalNum") + 1));
		runLater(1000 * .1, function(timeTask:TimedTask):Void
		{
			...
			_Item[Std.int(1)] = Engine.engine.getGameAttribute("L08TotalNum");
			_Item[Std.int(2)] = (("" + (("" + Date.now().getHours()) + ("" + ":"))) + ("" + (("" + (("" + Date.now().getMinutes()) + ("" + ":"))) + ("" + Date.now().getSeconds()))));
			Engine.engine.getGameAttribute("L08Date01")[Std.int(Engine.engine.getGameAttribute("L08TotalNum"))] = _Item;
		}, null);
