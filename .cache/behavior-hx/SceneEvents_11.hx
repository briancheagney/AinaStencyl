...
class SceneEvents_11 extends SceneScript
{
	...
	public function _customEvent_SideSwitcher2():Void
	{
		...
		trace((("Width of Card = ") + ("" + (_Match.getWidth()))));
		trace((("MatchX01 = ") + ("" + Engine.engine.getGameAttribute("MatchX01"))));
		trace((("MatchX02 = ") + ("" + Engine.engine.getGameAttribute("MatchX02"))));
		if((_LeftRightPicker == 1))
		{
	...
	override public function init()
	{
		...
		Engine.engine.setGameAttribute("L05TotalNum", ((Engine.engine.getGameAttribute("L05TotalNum") : Float) + 1));
		runLater(1000 * .1, function(timeTask:TimedTask):Void
		{
			...
			_Item[1] = (Engine.engine.getGameAttribute("L05TotalNum") : Float);
			_Item[2] = (((("" + Date.now().getHours()) + (":"))) + ((((("" + Date.now().getMinutes()) + (":"))) + ("" + Date.now().getSeconds()))));
			_Item[3] = 0;
			(Engine.engine.getGameAttribute("L05Date01") : Array<Dynamic>)[Std.int((Engine.engine.getGameAttribute("L05TotalNum") : Float))] = _Item;
		}, null);
		...
		addMouseOverActorListener(_Match, function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				if((_Matchable == true))
				{
					...
					_Match.setX(-1200);
					trace("True");
					trace((Engine.engine.getGameAttribute("L05Date01") : Array<Dynamic>));
					if((_counter == 10))
					{
