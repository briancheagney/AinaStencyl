 ...
 */
		...
		Engine.engine.setGameAttribute("L22TotalNum", ((Engine.engine.getGameAttribute("L22TotalNum") : Float) + 1));
		runLater(1000 * .1, function(timeTask:TimedTask):Void
		{
			...
			_Item[1] = (Engine.engine.getGameAttribute("L22TotalNum") : Float);
			_Item[2] = (((("" + Date.now().getHours()) + (":"))) + ((((("" + Date.now().getMinutes()) + (":"))) + ("" + Date.now().getSeconds()))));
			(Engine.engine.getGameAttribute("L22Date") : Array<Dynamic>)[Std.int((Engine.engine.getGameAttribute("L22TotalNum") : Float))] = _Item;
	...
	public function _customEvent_Created002():Void
	{
		...
		_TargetChooser = 0;
		/* Create the target */
		createRecycledActor(getActorType(260), (Engine.engine.getGameAttribute("TargetX") : Float), (Engine.engine.getGameAttribute("TargetY") : Float), Script.FRONT);
		_Target = getLastCreatedActor();
		_Target.disableActorDrawing();
		/* create the match */
		createRecycledActor(getActorType(260), (Engine.engine.getGameAttribute("MatchX") : Float), (Engine.engine.getGameAttribute("MatchY") : Float), Script.FRONT);
		...
		_LRMorderPicker = 0;
		_XPos1 = ((0.15 * getScreenWidth()) + (((0.85 * getScreenWidth()) - (4 * (_Match.getWidth()))) / 5));
		_Xpos2 = (((0.15 * getScreenWidth()) + (2 * (((0.85 * getScreenWidth()) - (4 * (_Match.getWidth()))) / 5))) + (_Match.getWidth()));
		_Xpos3 = (((0.15 * getScreenWidth()) + (3 * (((0.85 * getScreenWidth()) - (4 * (_Match.getWidth()))) / 5))) + (2 * (_Match.getWidth())));
		_Xpos4 = (((0.15 * getScreenWidth()) + (4 * (((0.85 * getScreenWidth()) - (4 * (_Match.getWidth()))) / 5))) + (3 * (_Match.getWidth())));
...
This is Rule 1 = shape matches! */
		...
		_ColorsGetters.push("Yellow");
		_ColorsGetters.push("Red");
		_ColorsGetters.push("Green");
		_ACCT = randomInt(1, 4);
	...
	public function _customEvent_Rule1Setup2():Void
	{
		...
		{
			_ChooseColorTarget = "Yellow";
			_ChooseColorNoMatch = "Yellow";
			_ATTYellowTaken = true;
		}
		else if((_ACCT == 3))
		{
			_ChooseColorTarget = "Red";
			_ChooseColorNoMatch = "Red";
			_ATTRedTaken = true;
		}
		else if((_ACCT == 4))
		{
			_ChooseColorTarget = "Green";
	...
	{
		/* Clubs become Circle
Diamond becomes Plus
Hearts become Squares
Moons become Stars */
...
ACC_MT = Color Chooser (Match True) */
	...
	public function _customEvent_Rule2Setup6():Void
	{
		...
		trace((("Target = ") + (((((_ChooseColorTarget) + (_ChooseShapeTarget))) + ((("0") + ("" + _ANCT)))))));
		trace((("Match = ") + (((((_ChooseColorMatch) + (_ChooseShapeMatch))) + ((("0") + ("" + _ANCM)))))));
		trace((("No Match = ") + (((((_ChooseColorNoMatch) + (_ChooseShapeNoMatch))) + ((("0") + ("" + _ANCMF)))))));
		trace((("No Match2 = ") + (((((_ChooseColorNoMatch2) + (_ChooseShapeNoMatch2))) + ((("0") + ("" + _ANCMF2)))))));
		_customEvent_ShowTargetEvent();
	}
...
ACC_MT = Color Chooser (Match True) */
	...
	public function _customEvent_ShowTargetEvent():Void
	{
		...
		_Target.growTo(100/100, 100/100, .1, Easing.linear);
		runLater(1000 * .1, function(timeTask:TimedTask):Void
		{
	...
	public function _customEvent_SideSwitcher():Void
	{
		...
		trace((("LeftRightPicker = ") + ("" + _LeftRightPicker)));
		trace((("LeftSideCounter = ") + ("" + _LeftSideCounter)));
		trace((("MidSideCounter = ") + ("" + _MidSideCounter)));
		trace((("RightSideCounter = ") + ("" + _RightSideCounter)));
	...
	public function _customEvent_CardPlacer():Void
	{
		...
		trace((((("NUMERO (char at pos)") + ((("" + _Match.getAnimation())).charAt(((("" + _Match.getAnimation())).length - 2))))) + ((("" + _Match.getAnimation())).charAt(((("" + _Match.getAnimation())).length - 1)))));
		if(((("" + _Match.getAnimation())).charAt(((("" + _Match.getAnimation())).length - 1)) == ("" + 1)))
		{
			_Match.setX(_XPos1);
			_01Taken = true;
		}
		else if(((("" + _Match.getAnimation())).charAt(((("" + _Match.getAnimation())).length - 1)) == ("" + 2)))
		{
			_Match.setX(_Xpos2);
			_02Taken = true;
		}
		else if(((("" + _Match.getAnimation())).charAt(((("" + _Match.getAnimation())).length - 1)) == ("" + 3)))
		{
			_Match.setX(_Xpos3);
			_03Taken = true;
		}
 ...
 */
		if(((("" + _NoMatch.getAnimation())).charAt(((("" + _NoMatch.getAnimation())).length - 1)) == ("" + 1)))
		{
			_NoMatch.setX(_XPos1);
			_01Taken = true;
		}
		else if(((("" + _NoMatch.getAnimation())).charAt(((("" + _NoMatch.getAnimation())).length - 1)) == ("" + 2)))
		{
			_NoMatch.setX(_Xpos2);
			_02Taken = true;
		}
		else if(((("" + _NoMatch.getAnimation())).charAt(((("" + _NoMatch.getAnimation())).length - 1)) == ("" + 3)))
		{
		...
		if(((("" + _NoMatch2.getAnimation())).charAt(((("" + _NoMatch2.getAnimation())).length - 1)) == ("" + 1)))
		{
			_NoMatch2.setX(_XPos1);
			_01Taken = true;
		}
		else if(((("" + _NoMatch2.getAnimation())).charAt(((("" + _NoMatch2.getAnimation())).length - 1)) == ("" + 2)))
		{
			_NoMatch2.setX(_Xpos2);
			_02Taken = true;
		}
		else if(((("" + _NoMatch2.getAnimation())).charAt(((("" + _NoMatch2.getAnimation())).length - 1)) == ("" + 3)))
		{
		...
		runLater(1000 * .25, function(timeTask:TimedTask):Void
		{
			...
			_NoMatch3.growTo(125/100, 125/100, .05, Easing.linear);
	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				if(((Engine.engine.getGameAttribute("KillActors") : Bool) == true))
				{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				g.drawString("" + ((Engine.engine.getGameAttribute("L22Date") : Array<Dynamic>).length - 1), 0, 5);
				g.setFont(getFont(102));
