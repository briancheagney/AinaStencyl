...
class SceneEvents_25 extends SceneScript
{
	...
	override public function init()
	{
		...
		Engine.engine.setGameAttribute("L09Col01TotalNum", ((Engine.engine.getGameAttribute("L09Col01TotalNum") : Float) + 1));
		runLater(1000 * .1, function(timeTask:TimedTask):Void
		{
			...
			_Item[1] = (Engine.engine.getGameAttribute("L09Col01TotalNum") : Float);
			_Item[2] = (((("" + Date.now().getHours()) + (":"))) + ((((("" + Date.now().getMinutes()) + (":"))) + ("" + Date.now().getSeconds()))));
			(Engine.engine.getGameAttribute("L09Date01") : Array<Dynamic>)[Std.int((Engine.engine.getGameAttribute("L09Col01TotalNum") : Float))] = _Item;
		}, null);
		...
		_Target.setAnimation("NullClubB");
